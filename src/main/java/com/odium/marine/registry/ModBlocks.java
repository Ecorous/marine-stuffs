...
public class ModBlocks
{
    ...
    public static final Block TYPHORITE_BLOCK = new Block(FabricBlockSettings.of(Material.METAL).hardness(50.0f));
    public static final Block TYPHORITE_ORE = new Block(FabricBlockSettings.of(Material.STONE).hardness(50.0f));
