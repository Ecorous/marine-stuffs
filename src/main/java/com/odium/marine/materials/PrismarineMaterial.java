...
public class PrismarineMaterial {
    public enum PrismMaterial implements ArmorMaterial{
        ...
        PrismMaterial(String name, int durabilityMultiplier, int[] armorValueArr, int enchantability, SoundEvent soundEvent, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
            this.name = name;
