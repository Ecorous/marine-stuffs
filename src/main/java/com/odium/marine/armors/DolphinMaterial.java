...
public class DolphinMaterial {
    public enum DolphinLeatherMaterial implements ArmorMaterial {
        ...
        DolphinLeatherMaterial(String name, int durabilityMultiplier, int[] armorValueArr, int enchantability, SoundEvent soundEvent, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
            this.name = name;
